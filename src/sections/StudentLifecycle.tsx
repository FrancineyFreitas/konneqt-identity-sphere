      ...
      <div className="container mx-auto relative z-10">
        <ScrollReveal>
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-light mb-4 text-white font-inter">
              <span className="font-light">{t('studentLifecycle.title')}</span> <span className="font-bold" style={{ color: '#1de28f' }}>{t('studentLifecycle.title.student')}</span>
            </h2>
            ...
            <ScrollReveal key={index} delay={index * 100}>
              <Card className="bg-slate-800/30 backdrop-blur-sm transition-all duration-300" style={{ border: '1px solid #2f2f2f' }}>
                <CardContent className="p-6 text-center">
                  <h3 className="text-lg font-semibold mb-3 text-white font-inter">{event.title}</h3>
        ...
        <ScrollReveal delay={600}>
          <div className="mt-16 bg-transparent rounded-2xl p-8 text-center">
            <h3 className="text-2xl font-bold mb-4 text-white font-inter">{t('studentLifecycle.instant.title')}</h3>
