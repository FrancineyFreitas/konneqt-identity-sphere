  ...
  return (
    <section className="py-20 px-4 bg-gradient-to-br from-slate-900 via-gray-900 to-black relative overflow-hidden">
      ...
      <div className="container mx-auto relative z-10">
        ...
        {/* Metrics Benefits Card */}
        <ScrollReveal delay={200}>
          <Card className="border border-cyan-500/40 bg-slate-800/30 backdrop-blur-sm hover:border-cyan-400 transition-all duration-300 hover:shadow-lg mb-16">
            <CardContent className="p-8">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center">
                {/* Metric 1: 5 min */}
                <div className="text-center">
                  <div className="text-4xl md:text-5xl font-bold text-cyan-400 mb-2 font-inter">
                    5 min
                  </div>
                  <div className="text-sm text-slate-300 font-inter">
                    {t('benefits.metrics.provisioning')}
                  </div>
                  <div className="text-sm text-slate-300 font-inter">
                    {t('benefits.metrics.deprovisioning')}
                  </div>
                </div>
                ...
                <div className="text-center">
                  ...
                  <div className="text-sm text-slate-300 font-inter">
                    {t('benefits.metrics.compliance')}
                  </div>
                  <div className="text-sm text-slate-300 font-inter">
                    {t('benefits.metrics.conformidade')}
                  </div>
                </div>
                ...
                <div className="text-center">
                  ...
                  <div className="text-sm text-slate-300 font-inter">
                    {t('benefits.metrics.reduction')}
                  </div>
                  <div className="text-sm text-slate-300 font-inter">
                    {t('benefits.metrics.tickets')}
                  </div>
                </div>
                ...
                <div className="text-center">
                  ...
                  <div className="text-sm text-slate-300 font-inter">
                    {t('benefits.metrics.systems')}
                  </div>
                  <div className="text-sm text-slate-300 font-inter">
                    {t('benefits.metrics.integrados')}
                  </div>
                </div>
              </div>
            </CardContent>
