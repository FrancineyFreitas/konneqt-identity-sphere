    ...
    <section id="contact" className="py-20 px-4 bg-gradient-to-br from-slate-900 via-gray-900 to-black relative overflow-hidden">
      ...
      <div className="container mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div>
            <ScrollReveal>
              <div className="border-[#2f2f2f] bg-slate-800/30 backdrop-blur-sm transition-all duration-300 hover:shadow-lg rounded-2xl p-8 shadow-lg relative overflow-hidden">
